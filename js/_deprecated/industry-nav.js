...
const INDUSTRY_NAV_CONFIG = [
  { title: '确信推荐', links: [
    { id: 'i_sec1', label: '高胜率赛道' },
    { id: 'i_sec_base', label: '底仓资产' }
  ]},
  { title: '深度挖掘', links: [
    { id: 'i_sec2', label: '二阶博弈' },
    { id: 'i_sec3', label: '困境反转' },
    { id: 'i_sec_satellite', label: '卫星仓位' }
  ]},
  { title: '数据追踪', links: [
    { id: 'i_sec_table1', label: '大宗量价' },
    { id: 'i_sec_table2', label: '估值监测' },
    { id: 'i_sec_diff', label: '分歧点说明' },
...
function renderIndustryNav() {
  ...
  container.innerHTML = INDUSTRY_NAV_CONFIG.map((group, idx) => `

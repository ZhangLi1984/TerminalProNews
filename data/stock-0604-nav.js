...
const STOCK_NAV_CONFIG_0604 = [
  {
    ...
    links: [
      { id: 'sec1', label: '核心摘要' },
      { id: 'sec2', label: 'S 级标的（4 只）' },
      { id: 'sec3', label: 'A 级标的（10 只）' }
    ]
  },
  {
    title: '评级汇总',
    links: [
      { id: 'sec4', label: '完整评级汇总表' },
      { id: 'sec5', label: '行业分布统计' },
      { id: 'sec6', label: '评级说明' }
    ]
  }
];
...
function renderStockNav_0604() {
  ...
  container.innerHTML = STOCK_NAV_CONFIG_0604.map(category => `
    <div class="space-y-3">

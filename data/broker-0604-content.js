...
function renderBrokerContent_0604() {
  return `<div class="prose prose-slate max-w-none">
    ...
    <ul class="space-y-2">
      <li class="py-2 border-b border-slate-100 last:border-0 flex items-start"><span class="w-1.5 h-1.5 rounded-full bg-blue-500 mt-2 mr-3 flex-shrink-0"></span><span><strong>中美AI资本开保持续高增：</strong>Alphabet 2026年资本支出预计1800-1900亿美元，2027年将"显著"增加；DeepSeek首轮融资估值最高590亿美元，腾讯、宁德时代将成为DeepSeek最大外部投资者。</span></li>
      <li class="py-2 border-b border-slate-100 last:border-0 flex items-start"><span class="w-1.5 h-1.5 rounded-full bg-blue-500 mt-2 mr-3 flex-shrink-0"></span><span><strong>美国PMI数据强劲：</strong>5月美国制造业PMI为54%，创2022年6月以来最高，AI领域投资增加是主要驱动力。</span></li>
      <li class="py-2 border-b border-slate-100 last:border-0 flex items-start"><span class="w-1.5 h-1.5 rounded-full bg-blue-500 mt-2 mr-3 flex-shrink-0"></span><span><strong>美联储政策转向：</strong>互换市场计价年内加息概率超80%，10年期美债收益率逼近4.5%。6月FOMC会议（沃什首秀）为关键观察窗口。</span></li>
      <li class="py-2 border-b border-slate-100 last:border-0 flex items-start"><span class="w-1.5 h-1.5 rounded-full bg-blue-500 mt-2 mr-3 flex-shrink-0"></span><span><strong>中东局势扰动油气价格：</strong>霍尔木兹海峡通行不确定性推升国际油价，2026年2月底以来最大涨幅超过60%。</span></li>
    </ul>
    ...
    <div class="bg-amber-50 border-l-4 border-amber-500 p-5 my-5 rounded-r-xl">
      <h4 class="text-amber-800 font-bold mb-3 flex items-center"><span class="text-xl mr-2">⚡</span>资金面关键信号</h4>
    ...
    <h3 id="b_sec3" class="text-xl font-black text-slate-900 mt-8 mb-4 pb-2 border-b border-slate-200">被 3 家及以上券商推荐的行业</h3>

    <div class="overflow-x-auto my-6">
      <table class="min-w-full border-collapse border border-slate-200 rounded-xl overflow-hidden shadow-sm">
        <thead class="bg-slate-900 text-white">
          <tr><th class="px-4 py-3 text-left">行业</th><th class="px-4 py-3 text-center">次数</th><th class="px-4 py-3 text-left">核心逻辑</th><th class="px-4 py-3 text-left">推荐券商</th></tr>
        </thead>
        <tbody class="bg-white divide-y divide-slate-100">
          <tr class="bg-green-50 hover:bg-green-100"><td class="px-4 py-3 font-bold text-green-900">半导体/AI算力硬件</td><td class="px-4 py-3 text-center font-bold text-green-800">6次</td><td class="px-4 py-3 text-sm">韬定律引领芯片新路径；Scaleup超节点爆发驱动交换芯片需求；国产替代加速</td><td class="px-4 py-3 text-xs">东兴、开源、国信、山西、东吴、东海</td></tr>
          <tr class="bg-green-50 hover:bg-green-100"><td class="px-4 py-3 font-bold text-green-900">通信/光通信</td><td class="px-4 py-3 text-center font-bold text-green-800">5次</td><td class="px-4 py-3 text-sm">交换芯片从配角变主角，与GPU配比大幅提升；硅光技术量产；光模块需求爆发</td><td class="px-4 py-3 text-xs">东兴、开源、国信、山西、东海</td></tr>
          <tr class="bg-green-50 hover:bg-green-100"><td class="px-4 py-3 font-bold text-green-900">医药/创新药</td><td class="px-4 py-3 text-center font-bold text-green-800">4次</td><td class="px-4 py-3 text-sm">ASCO年会中国创新药数据亮眼；信达生物与辉瑞达成105亿美元BD合作</td><td class="px-4 py-3 text-xs">东海、国信、华源、中银</td></tr>
          <tr class="hover:bg-slate-50"><td class="px-4 py-3 font-bold">化工/氟化工</td><td class="px-4 py-3 text-center font-bold text-blue-800">3次</td><td class="px-4 py-3 text-sm">制冷剂配额约束持续收紧，三代制冷剂供需紧平衡；PTFE有望应用于英伟达M10 CCL</td><td class="px-4 py-3 text-xs">国信、开源、山西</td></tr>
          <tr class="hover:bg-slate-50"><td class="px-4 py-3 font-bold">煤炭/能源</td><td class="px-4 py-3 text-center font-bold text-blue-800">3次</td><td class="px-4 py-3 text-sm">山西安监升级导致供给收紧；中东冲突推升油价中枢上移；夏季用电高峰提前到来</td><td class="px-4 py-3 text-xs">第一创业、国信、中银</td></tr>
          <tr class="hover:bg-slate-50"><td class="px-4 py-3 font-bold">电力设备/新能源</td><td class="px-4 py-3 text-center font-bold text-blue-800">3次</td><td class="px-4 py-3 text-sm">非化石能源电力消费核算指南出台，绿证需求扩容；储能配储成为AI数据中心"必选项"</td><td class="px-4 py-3 text-xs">华源、国信、第一创业</td></tr>
        </tbody>
      </table>
    </div>
    ...
    <h3 id="b_sec4" class="text-xl font-black text-slate-900 mt-8 mb-4 pb-2 border-b border-slate-200">被 2 家券商同时推荐的个股</h3>

    <div class="overflow-x-auto my-6">
      <table class="min-w-full border-collapse border border-slate-200 rounded-xl overflow-hidden shadow-sm">
        <thead class="bg-slate-900 text-white">
          <tr><th class="px-4 py-3 text-left">股票</th><th class="px-4 py-3 text-center">代码</th><th class="px-4 py-3 text-left">推荐券商</th><th class="px-4 py-3 text-left">核心逻辑</th></tr>
        </thead>
        <tbody class="bg-white divide-y divide-slate-100">
          <tr class="bg-purple-50 hover:bg-purple-100"><td class="px-4 py-3 font-bold text-purple-900">杰瑞股份</td><td class="px-4 py-3 text-center text-sm">002353</td><td class="px-4 py-3 text-xs">东吴（买入）×2天</td><td class="px-4 py-3 text-sm">前瞻性布局浮式核能，燃气轮机订单持续兑现，SMR强化中长期技术储备</td></tr>
          <tr class="bg-purple-50 hover:bg-purple-100"><td class="px-4 py-3 font-bold text-purple-900">盛科通信</td><td class="px-4 py-3 text-center text-sm">688702</td><td class="px-4 py-3 text-xs">山西（买入）、开源（推荐）</td><td class="px-4 py-3 text-sm">国产以太网交换芯片龙头，OISA生态核心卡位玩家；Scaleup超节点需求爆发</td></tr>
          <tr class="hover:bg-slate-50"><td class="px-4 py-3 font-bold">比亚迪</td><td class="px-4 py-3 text-center text-sm">002594</td><td class="px-4 py-3 text-xs">开源（买入）、东海（关注）</td><td class="px-4 py-3 text-sm">5月海外销量首破16万辆，国内销量环比+19.8%；智驾芯片"璇玑A3"量产</td></tr>
          <tr class="hover:bg-slate-50"><td class="px-4 py-3 font-bold">羚锐制药</td><td class="px-4 py-3 text-center text-sm">600285</td><td class="px-4 py-3 text-xs">东海（买入）×2天</td><td class="px-4 py-3 text-sm">业绩稳健增长，毛利率分红率双升；银谷制药并表增厚业绩</td></tr>
          <tr class="hover:bg-slate-50"><td class="px-4 py-3 font-bold">中国核电</td><td class="px-4 py-3 text-center text-sm">601985</td><td class="px-4 py-3 text-xs">华源（推荐）、国信（推荐）</td><td class="px-4 py-3 text-sm">核电电力消费量以电能量交易认定；绿证需求扩容受益</td></tr>
          <tr class="hover:bg-slate-50"><td class="px-4 py-3 font-bold">中国广核</td><td class="px-4 py-3 text-center text-sm">003816</td><td class="px-4 py-3 text-xs">华源（推荐）、国信（推荐）</td><td class="px-4 py-3 text-sm">核电运营商，绿证需求扩容受益标的</td></tr>
        </tbody>
      </table>
    </div>

    <h4 class="font-bold text-slate-800 mt-5 mb-3">6月金股组合</h4>
    ...
    <h3 id="b_sec5" class="text-xl font-black text-slate-900 mt-8 mb-4 pb-2 border-b border-slate-200">各券商晨报要点</h3>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-5 my-4 hover:border-slate-300 transition-colors">
      ...
      <p class="text-sm text-slate-700"><strong>重点推荐：</strong>松发股份（603268）首次覆盖"增持"，全球第三大船厂，2026-2028年PE 18/10/8倍；杰瑞股份（002353）维持"买入"，布局浮式核能</p>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-5 my-4 hover:border-slate-300 transition-colors">
      ...
      <p class="text-sm text-slate-700"><strong>重点推荐：</strong>比亚迪（002594）维持"买入"，海外销量持续高增；汇量科技（01860.HK）维持"买入"，AI Infra驱动高增；骆驼股份（601311）维持"买入"</p>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-5 my-4 hover:border-slate-300 transition-colors">
      ...
      <p class="text-sm text-slate-700"><strong>金股组合：</strong>宝武镁业、北京利尔、兴森科技、亨通光电、安井食品、火炬电子、金诚信、日联科技</p>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-5 my-4 hover:border-slate-300 transition-colors">
      ...
      <p class="text-sm text-slate-700"><strong>重点推荐：</strong>盛科通信（688702）首次覆盖"买入"，Scaleup超节点需求爆发；广和通（300638）维持"买入"，拟收购航盛电子拓展车载方案</p>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-5 my-4 hover:border-slate-300 transition-colors">
      ...
      <p class="text-sm text-slate-700"><strong>重点推荐：</strong>保险股（中国太保、中国财险）；氟化工（巨化股份、东岳集团、三美股份）；绿联科技（301606）首次覆盖"优于大市"，目标价87.8-93.9元</p>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-5 my-4 hover:border-slate-300 transition-colors">
      ...
      <p class="text-sm text-slate-700"><strong>重点推荐：</strong>妙可蓝多（600882）首次覆盖"增持"，原制奶酪国产替代</p>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-5 my-4 hover:border-slate-300 transition-colors">
      ...
      <p class="text-sm text-slate-700"><strong>关注方向：</strong>第三代半导体（GaN/SiC）、工程机械涨价、3D打印机出口翻倍</p>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-5 my-4 hover:border-slate-300 transition-colors">
      ...
      <p class="text-sm text-slate-700"><strong>重点推荐：</strong>医药创新药：科伦药业、众生药业、贝达药业、羚锐制药等</p>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-5 my-4 hover:border-slate-300 transition-colors">
      ...
      <p class="text-sm text-slate-700"><strong>重点推荐：</strong>石油石化（中国石油、中国海油、中国石化）；油服（海油发展、中海油服、杰瑞股份）；骨科耗材（三友医疗、威高骨科、大博医疗）；券商（中信证券、国泰海通、华泰证券）</p>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-5 my-4 hover:border-slate-300 transition-colors">
      ...
      <p class="text-sm text-slate-700"><strong>重点推荐：</strong>绿电运营商（龙源电力H、大唐新能源、中广核新能源）；核电运营商（中国核电、中国广核）；医药（福瑞医科300049、信立泰002294）均维持"买入"</p>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-5 my-4 hover:border-slate-300 transition-colors">
      ...
      <p class="text-sm text-slate-700"><strong>关注方向：</strong>光通信、AI算力、3D打印出口</p>
    </div>
    ...
    <h3 id="b_sec6" class="text-xl font-black text-slate-900 mt-8 mb-4 pb-2 border-b border-slate-200">共同风险提示</h3>

    <div class="overflow-x-auto my-6">
      <table class="min-w-full border-collapse border border-slate-200 rounded-xl overflow-hidden shadow-sm">
        <thead class="bg-red-700 text-white">
          <tr><th class="px-4 py-3 text-left">风险类型</th><th class="px-4 py-3 text-left">具体内容</th><th class="px-4 py-3 text-left">提及券商</th></tr>
        </thead>
        <tbody class="bg-white divide-y divide-slate-100">
          <tr class="bg-red-50 hover:bg-red-100"><td class="px-4 py-3 font-bold text-red-900">地缘政治风险</td><td class="px-4 py-3 text-sm">中东冲突（霍尔木兹海峡通行）、美伊谈判、中美贸易摩擦</td><td class="px-4 py-3 text-xs">中银、国信、东海、第一创业、东兴</td></tr>
          <tr class="bg-red-50 hover:bg-red-100"><td class="px-4 py-3 font-bold text-red-900">美联储政策风险</td><td class="px-4 py-3 text-sm">加息概率超80%，6月FOMC沃什首秀鹰派倾向</td><td class="px-4 py-3 text-xs">东吴、山西、国信</td></tr>
          <tr class="hover:bg-slate-50"><td class="px-4 py-3 font-bold">AI资本开支不及预期</td><td class="px-4 py-3 text-sm">算力投入放缓影响产业链景气度</td><td class="px-4 py-3 text-xs">东吴、开源、山西</td></tr>
          <tr class="hover:bg-slate-50"><td class="px-4 py-3 font-bold">行业竞争加剧</td><td class="px-4 py-3 text-sm">科技赛道拥挤度高、估值回调压力</td><td class="px-4 py-3 text-xs">山西、东海、开源</td></tr>
          <tr class="hover:bg-slate-50"><td class="px-4 py-3 font-bold">原材料价格波动</td><td class="px-4 py-3 text-sm">存储芯片涨价、油价波动、大宗商品价格波动</td><td class="px-4 py-3 text-xs">山西、第一创业、国信</td></tr>
          <tr class="hover:bg-slate-50"><td class="px-4 py-3 font-bold">政策不确定性</td><td class="px-4 py-3 text-sm">集采政策、绿证政策落地不及预期、关税政策</td><td class="px-4 py-3 text-xs">东海、华源、开源</td></tr>
        </tbody>
      </table>
    </div>

    <h3 id="b_sec7" class="text-xl font-black text-slate-900 mt-8 mb-4 pb-2 border-b border-slate-200">关键事件跟踪</h3>
    ...
    <h3 id="b_sec8" class="text-xl font-black text-slate-900 mt-8 mb-4 pb-2 border-b border-slate-200">综合投资建议</h3>
        ...
        <div>
          ...
          <div class="bg-white rounded-lg p-4 my-3 border border-indigo-100">
            <h6 class="font-bold text-green-700 mb-2 flex items-center">
              <span class="bg-green-100 text-green-800 px-2 py-0.5 rounded text-xs mr-2">第一优先</span>AI算力硬件产业链
            </h6>
          ...
          <div class="bg-white rounded-lg p-4 my-3 border border-indigo-100">
            <h6 class="font-bold text-blue-700 mb-2 flex items-center">
              <span class="bg-blue-100 text-blue-800 px-2 py-0.5 rounded text-xs mr-2">第二优先</span>高股息防御资产
            </h6>
            <ul class="text-sm text-slate-700 space-y-1">
          ...
          <div class="bg-white rounded-lg p-4 my-3 border border-indigo-100">
            <h6 class="font-bold text-purple-700 mb-2 flex items-center">
              <span class="bg-purple-100 text-purple-800 px-2 py-0.5 rounded text-xs mr-2">第三优先</span>医药创新药
            </h6>
            <ul class="text-sm text-slate-700 space-y-1">
          ...
          <div class="bg-white rounded-lg p-4 my-3 border border-indigo-100">
            <h6 class="font-bold text-orange-700 mb-2 flex items-center">
              <span class="bg-orange-100 text-orange-800 px-2 py-0.5 rounded text-xs mr-2">第四优先</span>油气产业链
            </h6>
            <ul class="text-sm text-slate-700 space-y-1">

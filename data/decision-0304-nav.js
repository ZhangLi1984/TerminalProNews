// test======================================
// 文档一：投资决策内参 - 导航配置 (3 月 4 日版)
// ==========================================

const DECISION_NAV_CONFIG_0304 = [
  { title: '全局视野', links: [{ id: 'sec1', label: '核心摘要与主线' }] },
  { title: 'S 级推演', links: [
    { id: 'sec2_s1', label: 'S1. AI 算力/半导体' },
    { id: 'sec2_s2', label: 'S2. 人形机器人' },
    { id: 'sec2_s3', label: 'S3. 通信/光模块' }
  ]},
  { title: 'A 级事件', links: [
  ...
  { title: '前瞻风控', links: [{ id: 'sec6', label: '本周策略与预警' }] }
];

/**
 * 渲染侧边导航
 */
function renderDecisionNav_0304() {
  const container = document.getElementById('decision-nav-content');
  if (!container) return;

  container.innerHTML = DECISION_NAV_CONFIG_0304.map((group, idx) => `

// ==========================================
// 券商晨报导航模块 - 2026 年 6 月 29 日
// ==========================================

const BROKER_NAV_CONFIG_0629 = [
  {
    title: '晨报摘要',
    links: [
  ...
  },
  {
    ...
    links: [
      ...
      { id: 'b_sec8', label: '各券商重点推荐' }
    ]
  },
  {
    title: '策略建议',
    links: [
      { id: 'b_sec9', label: '攻守兼备策略' },
      { id: 'b_sec10', label: '短期交易机会' },
      { id: 'b_sec11', label: '风险提示' }
    ]
  }
];

function renderBrokerNav_0629() {
  const container = document.getElementById('broker-nav-content');
  if (!container) return;

  container.innerHTML = BROKER_NAV_CONFIG_0629.map((section, index) => `
    <div class="space-y-2">

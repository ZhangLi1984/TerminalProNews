function renderMacroContent_0617() {
  return `<div class="prose prose-slate max-w-none">
    ...
    <h3 id="sec1" class="text-xl font-black text-slate-900 mt-8 mb-4 pb-2 border-b border-slate-200">美林时钟定位：滞胀初期</h3>
    <ul class="list-none space-y-3 my-6">
      <li class="py-2 border-b border-slate-100 last:border-0 flex items-start"><span class="w-1.5 h-1.5 rounded-full bg-red-500 mt-2 mr-3 flex-shrink-0"></span><span><strong>经济特征</strong>：经济增长放缓（GDP降至4.2%）+ 输入性通胀上升（PPI达3.9%）的组合，符合滞胀特征。</span></li>
      <li class="py-2 border-b border-slate-100 last:border-0 flex items-start"><span class="w-1.5 h-1.5 rounded-full bg-red-500 mt-2 mr-3 flex-shrink-0"></span><span><strong>下一阶段展望</strong>：若美伊局势缓和导致油价回落，同时国内财政发力提振内需，经济可能向"复苏"阶段过渡；但若地缘冲突升级，滞胀压力将持续。</span></li>
      <li class="py-2 border-b border-slate-100 last:border-0 flex items-start"><span class="w-1.5 h-1.5 rounded-full bg-red-500 mt-2 mr-3 flex-shrink-0"></span><span><strong>库存周期</strong>：传统制造业面临"增产不增收、增收不增利"，处于被动补库向主动去库过渡阶段；高技术产业处于主动补库繁荣期。</span></li>
    </ul>
    ...
    <h2 class="text-2xl font-black text-slate-900 mt-10 mb-6 flex items-center"><span class="w-2 h-8 bg-red-600 rounded-full mr-3"></span>货币政策与流动性分析</h2>

    <h3 id="sec4" class="text-xl font-black text-slate-900 mt-8 mb-4 pb-2 border-b border-slate-200">政策立场：中性偏宽松</h3>
    <ul class="list-none space-y-3 my-6">
    ...
    <ul class="list-none space-y-3 my-6">
      <li class="py-2 border-b border-slate-100 last:border-0 flex items-start"><span class="w-1.5 h-1.5 rounded-full bg-red-500 mt-2 mr-3 flex-shrink-0"></span><span><strong>政策重点支持的产业方向</strong>：<br/>1. <strong>AI产业链</strong>：算力基础设施、半导体设备材料、人形机器人（专项行动开启，万台级落地）。<br/>2. <strong>"十五五"新基建</strong>：算力网、新一代通信网、物流网、城市地下管网。<br/>3. <strong>高技术制造</strong>：集成电路、工业机器人、3D打印设备、航空航天。<br/>4. <strong>出海链</strong>：工程机械、电网设备、跨境电商。<br/>5. <strong>合规跨境金融</strong>：头部券商、港股通/QDII渠道（受益于非法跨境平台整治）。</span></li>
    </ul>

    <h2 class="text-2xl font-black text-slate-900 mt-10 mb-6 flex items-center"><span class="w-2 h-8 bg-red-600 rounded-full mr-3"></span>资产配置建议 (核心输出)</h2>

    <h3 id="sec7" class="text-xl font-black text-slate-900 mt-8 mb-4 pb-2 border-b border-slate-200">各类资产配置策略</h3>
    ...
    <h2 class="text-2xl font-black text-slate-900 mt-10 mb-6 flex items-center"><span class="w-2 h-8 bg-red-600 rounded-full mr-3"></span>行业轮动与宏观映射</h2>

    <h3 id="sec8" class="text-xl font-black text-slate-900 mt-8 mb-4 pb-2 border-b border-slate-200">宏观变量到行业逻辑的传导</h3>
    <ul class="list-none space-y-3 my-6">
      <li class="py-2 border-b border-slate-100 last:border-0 flex items-start"><span class="w-1.5 h-1.5 rounded-full bg-red-500 mt-2 mr-3 flex-shrink-0"></span><span><strong>AI产业链</strong> - 宏观驱动：全球AI资本开支持续高增 + 出口链景气<br/><strong>宏观变量→行业逻辑</strong>：微软Azure增速38%、AWS增速25%，云收入超预期。英伟达H100 GPU租赁价格持续上行。中国计算机及零部件出口同比加速至66%，集成电路出口激增111%。<br/><strong>重点标的</strong>：CPO/PCB/存储龙头、半导体设备材料、算力租赁服务商。</span></li>
    ...
    <h3 id="sec9" class="text-xl font-black text-slate-900 mt-8 mb-4 pb-2 border-b border-slate-200">外部风险与内部风险</h3>
    <ul class="list-none space-y-3 my-6">
      <li class="py-2 border-b border-slate-100 last:border-0 flex items-start"><span class="w-1.5 h-1.5 rounded-full bg-red-500 mt-2 mr-3 flex-shrink-0"></span><span><strong>外部风险</strong>：<br/>- <strong>美伊局势不确定性</strong>：虽然协议文本已基本敲定，但双方在部分条款上仍存分歧，后续变数仍存。若谈判破裂或军事冲突升级，可能导致油价失控。<br/>- <strong>美联储政策反复</strong>：沃什首秀在即，若核心通胀继续上升则加息概率加大。市场已定价12月加息25bp的概率为35%-40%。<br/>- <strong>欧美经济衰退超预期</strong>：欧元区一季度GDP环比萎缩0.2%，滞胀风险凸显。</span></li>
      <li class="py-2 border-b border-slate-100 last:border-0 flex items-start"><span class="w-1.5 h-1.5 rounded-full bg-red-500 mt-2 mr-3 flex-shrink-0"></span><span><strong>内部风险</strong>：<br/>- <strong>政策执行的不确定性</strong>：增量财政刺激不及预期，内需持续低迷可能引发就业风险。<br/>- <strong>房地产改善的持续性</strong>：仅一线城市二手房价环比微涨，二三线城市继续下跌，地产链负反馈无法止住。<br/>- <strong>通缩压力卷土重来</strong>：若油价回落导致PPI环比转负，核心CPI持续低迷可能重新主导市场预期。</span></li>
    </ul>

    <h3 class="text-xl font-black text-slate-900 mt-8 mb-4 pb-2 border-b border-slate-200">证伪指标：若逻辑错误，以下数据会先恶化</h3>
    <ol class="list-decimal list-inside space-y-2 my-4 text-slate-700">
      <li><strong>出口增速回落</strong>：若全球AI资本开支放缓或贸易摩擦加剧，出口增速将从19.4%快速回落。</li>
      <li><strong>PPI环比转负</strong>：若油价跌破80美元/桶且内需无改善，PPI可能重新陷入通缩。</li>
      <li><strong>社融存量增速跌破7%</strong>：信贷结构持续恶化将验证实体经济融资需求进一步走弱。</li>
      <li><strong>一线城市房价环比转跌</strong>：若核心城市房价企稳信号消失，地产链负反馈将加剧。</li>
      <li><strong>美国核心CPI突破3%</strong>：若能源通胀扩散至核心服务，美联储加息概率将大幅上升，压制全球风险资产。</li>
    </ol>
  </div>`;
}

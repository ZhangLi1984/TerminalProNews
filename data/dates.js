...
const AVAILABLE_DATES = [
  { date: '2026-05-13', label: '2026 年 5 月 13 日', tag: 'latest', tagLabel: '最新' },
  { date: '2026-05-12', label: '2026 年 5 月 12 日', tag: 'history', tagLabel: '历史' },
  { date: '2026-05-11', label: '2026 年 5 月 11 日', tag: 'history', tagLabel: '历史' },
  { date: '2026-05-09', label: '2026 年 5 月 9 日', tag: 'history', tagLabel: '历史' },
  { date: '2026-05-08', label: '2026 年 5 月 8 日', tag: 'history', tagLabel: '历史' },
  { date: '2026-05-07', label: '2026 年 5 月 7 日', tag: 'history', tagLabel: '历史' },
  { date: '2026-05-06', label: '2026 年 5 月 6 日', tag: 'history', tagLabel: '历史' },
  { date: '2026-04-30', label: '2026 年 4 月 30 日', tag: 'history', tagLabel: '历史' },
  { date: '2026-04-28', label: '2026 年 4 月 28 日', tag: 'history', tagLabel: '历史' },
  { date: '2026-04-24', label: '2026 年 4 月 24 日', tag: 'history', tagLabel: '历史' },
  { date: '2026-04-23', label: '2026 年 4 月 23 日', tag: 'history', tagLabel: '历史' },
  { date: '2026-04-22', label: '2026 年 4 月 22 日', tag: 'history', tagLabel: '历史' },
  { date: '2026-04-21', label: '2026 年 4 月 21 日', tag: 'history', tagLabel: '历史' },
  { date: '2026-04-20', label: '2026 年 4 月 20 日', tag: 'history', tagLabel: '历史' },
  { date: '2026-04-19', label: '2026 年 4 月 19 日', tag: 'history', tagLabel: '历史' },
  { date: '2026-04-17', label: '2026 年 4 月 17 日', tag: 'history', tagLabel: '历史' },
...
// 当前选中日期（2026-05-13 最新）
let currentDate = '2026-05-13';

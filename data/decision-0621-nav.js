const DECISION_NAV_CONFIG_0621 = [
  {
    title: '核心摘要',
    links: [
  ...
  },
  {
    title: '重大事件深度推理',
    links: [
      { id: 'sec3', label: '美伊谅解备忘录与地缘风险' },
      { id: 'sec4', label: '陆家嘴论坛金融开放信号' },
      { id: 'sec5', label: 'AI算力产业链涨价潮' }
    ]
  },
  {
    title: '重要新闻与资金博弈',
...
function renderDecisionNav_0621() {
  const container = document.getElementById('decision-nav-content');
  if (!container) return;

  container.innerHTML = DECISION_NAV_CONFIG_0621.map(category => `
    <div class="mb-6">

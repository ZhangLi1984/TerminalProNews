const JISILU_NAV_CONFIG_0705 = [
  ...
  },
  {
    "title": "其他",
    "links": [
      { "id": "sec1", "label": "2026年7月5日 集思录投资洞察报告" },
      { "id": "sec12", "label": "六、今日金句" },
      { "id": "sec13", "label": "七、明日关注" }
    ]
  }
];

function renderJisiluNav_0705() {
  const container = document.getElementById('jisilu-nav-content');
  if (!container) return;

  let html = '';
  JISILU_NAV_CONFIG_0705.forEach(section => {
    html += `
      <div class="mb-6">

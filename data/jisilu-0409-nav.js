// ==========================================
// 集思录导航模块 - 2026 年 4 月 9 日
// ==========================================

const JISILU_NAV_CONFIG_0409 = [
  {
    title: '热门话题',
    links: [
      { id: 'j_sec1', label: '闻泰转债下修博弈' },
      { id: 'j_sec2', label: '期指贴水策略' },
      { id: 'j_sec3', label: '微盘股清仓讨论' },
      { id: 'j_sec4', label: '券商合并套利' },
      { id: 'j_sec5', label: '可转债调仓' }
    ]
  },
  {
    title: '宏观与行业',
    links: [
      { id: 'j_sec6', label: '美伊地缘冲突' },
      { id: 'j_sec7', label: '房地产政策跟踪' },
      { id: 'j_sec8', label: '实物茅台/期权' }
    ]
  },
  {
    title: '投资策略',
...
function renderJisiluNav_0409() {
  const container = document.getElementById('jisilu-nav-content');
  if (!container) return;

  container.innerHTML = JISILU_NAV_CONFIG_0409.map(category => `
    <div class="mb-6">

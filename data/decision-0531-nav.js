...
const DECISION_NAV_CONFIG_0531 = [
  ...
  },
  {
    title: '重大事件推演',
    links: [
      { id: 'd_sec3', label: '霍尔木兹海峡危机升级' },
      { id: 'd_sec4', label: '5月PMI降至50.0%' },
      { id: 'd_sec5', label: 'Anthropic估值反超OpenAI' },
    ]
  },
  {
    title: '行业信号追踪',
    links: [
      ...
      { id: 'd_sec7', label: '新能源/电力' },
      { id: 'd_sec8', label: '医药' },
      { id: 'd_sec9', label: '机器人/低空经济' },
      { id: 'd_sec10', label: '金融/宏观' },
    ]
  },
  {
    title: '赛道与传导',
    links: [
      { id: 'd_sec11', label: '热点赛道追踪' },
      { id: 'd_sec12', label: '跨赛道传导分析' },
    ]
  },
  {
    title: '明日关注与风控',
    links: [
      { id: 'd_sec13', label: '明日重要事件' },
      { id: 'd_sec14', label: '风险提示与证伪区' },
    ]
  },
];
...
function renderDecisionNav_0531() {
  ...
  if (!container) return;
  container.innerHTML = DECISION_NAV_CONFIG_0531.map(cat => `
    <div class="mb-4">

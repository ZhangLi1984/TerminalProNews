...
const DECISION_NAV_CONFIG_0527 = [
  {
    ...
    links: [
      ...
      { id: 'd_sec2', label: '美伊谈判破裂地缘升级' },
      { id: 'd_sec3', label: '美光市值破万亿存储周期' }
    ]
  },
  {
    title: '热点赛道',
    links: [
      { id: 'd_sec4', label: '半导体/先进封装' },
      { id: 'd_sec5', label: '存储芯片' },
      { id: 'd_sec6', label: '人形机器人' },
      { id: 'd_sec7', label: '铝/有色金属' },
      { id: 'd_sec8', label: '商业航天' }
    ]
  },
  {
    title: '操作策略',
    links: [
      { id: 'd_sec9', label: '跨赛道传导分析' },
      { id: 'd_sec10', label: '明日关注与风险提示' }
    ]
  }
];

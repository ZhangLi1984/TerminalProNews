...
const JISILU_NAV_CONFIG_0509 = [
  { title: '热门话题TOP10', links: [
    { id: 'sec1', label: '闻泰转债危机' },
    { id: 'sec2', label: '转债四傻风险' },
    { id: 'sec3', label: 'ST股最后盛宴' },
    { id: 'sec4', label: '科技股抱团焦虑' },
    { id: 'sec5', label: '高股息价值坚守' },
    { id: 'sec6', label: '孔曼子多策略' },
    { id: 'sec7', label: '网格交易利器' },
    { id: 'sec8', label: '期货贴水策略' },
    { id: 'sec9', label: '纳斯达克100' },
    { id: 'sec10', label: '券商股满仓' }
  ]},
  { title: '投资方法论', links: [

...
const DECISION_NAV_CONFIG_0422 = [
  { title: '核心摘要', links: [{ id: 'd_sec1', label: '全局叙事与操作方向' }] },
  { title: '重大事件', links: [
    { id: 'd_sec2', label: '美伊停火到期' },
    { id: 'd_sec3', label: '苹果CEO换帅' },
    { id: 'd_sec4', label: '沃什听证会' }
  ] },
  { title: '行业催化', links: [
    { id: 'd_sec5', label: '宁德时代钠电量产' },
    { id: 'd_sec6', label: '国务院服务业100万亿' },
    { id: 'd_sec7', label: 'AI算力产业链' },
    { id: 'd_sec8', label: '人形机器人' },
    { id: 'd_sec9', label: '商业航天' },
    { id: 'd_sec10', label: '猪周期' }
  ] },
  { title: '赛道跟踪', links: [{ id: 'd_sec11', label: '热点赛道追踪' }] },
  { title: '跨市场传导', links: [{ id: 'd_sec12', label: '二阶思维传导链' }] },
  { title: '明日关注', links: [{ id: 'd_sec13', label: '4月23日关键关注点' }] },
  { title: '风险提示', links: [{ id: 'd_sec14', label: '避雷针与逻辑证伪' }] }
];
...
function renderDecisionNav_0422() {
  ...
  container.innerHTML = DECISION_NAV_CONFIG_0422.map(group => `
    <div>

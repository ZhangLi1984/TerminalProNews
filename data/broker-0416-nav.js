...
const BROKER_NAV_CONFIG_0416 = [
  ...
  },
  {
    title: '策略观点',
    links: [
      { id: 'b_sec3', label: '10家券商宏观策略' }
    ]
  },
  {
    title: '行业推荐',
    links: [
      { id: 'b_sec4', label: 'AI算力/半导体' },
      { id: 'b_sec5', label: '人形机器人' },
      { id: 'b_sec6', label: '创新药/ADC' },
      { id: 'b_sec7', label: '商业航天/军工' },
      { id: 'b_sec8', label: '电力设备/锂电' },
      { id: 'b_sec9', label: '银行/非银' },
      { id: 'b_sec10', label: '食品饮料/白酒' }
    ]
  },
  {
    title: '金股组合',
    links: [
      { id: 'b_sec11', label: '中银/东兴4月金股' }
    ]
  },
  {
    title: '风险提示',
    links: [
      { id: 'b_sec12', label: '分歧与风险点' },
      { id: 'b_sec13', label: '本周事件日历' }
    ]
  }
];
...
function renderBrokerNav_0416() {
  ...
  if (!container) return;
  container.innerHTML = BROKER_NAV_CONFIG_0416.map(group => `
    <div>

...
const JISILU_NAV_CONFIG_0318 = [
  {
    title: '热门话题',
    links: [
      { id: 'j_sec1', label: 'TOP1 可转债强赎博弈' },
      { id: 'j_sec2', label: 'TOP2 配债一手党' },
      { id: 'j_sec3', label: 'TOP3 生猪周期布局' },
      { id: 'j_sec4', label: 'TOP4 B 股高股息' }
    ]
  },
  {
    title: '投资方法论',
    links: [
      { id: 'j_sec5', label: '可转债摊大饼策略' },
      { id: 'j_sec6', label: '股指期权卖沽策略' },
  ...
  },
  {
    title: '热议标的',
    links: [
      { id: 'j_sec8', label: '永冠转债/信服转债' },
      { id: 'j_sec9', label: '宝丰能源/生猪期货' }
    ]
  },
  {
    title: '市场情绪',
...
function renderJisiluNav_0318() {
  const container = document.getElementById('jisilu-nav-content');
  if (!container) return;

  container.innerHTML = JISILU_NAV_CONFIG_0318.map(section => `

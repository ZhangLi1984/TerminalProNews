// ==========================================
// 期货分析报告导航配置 - 2026-05-09
// ==========================================

const FUTURES_NAV_CONFIG_0509 = [
  { title: '今日提示', links: [
    { id: 'f_sec1', label: '数据说明' }
  ]}
];

function renderFuturesNav_0509() {
  const container = document.getElementById('futures-nav-content');
  if (!container) return;

  container.innerHTML = FUTURES_NAV_CONFIG_0509.map(group => `
    <div>

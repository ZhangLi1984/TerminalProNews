...
function renderStockContent_0310() {
  return `<div class="prose prose-slate max-w-none">
    ...
    <h3 id="sec1" class="text-xl font-black text-slate-900 mt-8 mb-4 pb-2 border-b border-slate-200">今日核心观点</h3>
    ...
    <div class="bg-slate-50 rounded-xl p-5 my-6 border border-slate-200">
      <h4 class="text-sm font-black text-slate-700 uppercase tracking-widest mb-3">评级说明</h4>
      <div class="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
        <div class="bg-purple-50 rounded-lg p-3 border border-purple-200">
          <div class="font-bold text-purple-700">S 级（&gt;8.5 分）</div>
          <div class="text-slate-600 text-xs mt-1">极度看好，超额收益预期&gt;30%</div>
        </div>
        <div class="bg-blue-50 rounded-lg p-3 border border-blue-200">
          <div class="font-bold text-blue-700">A 级（7-8.5 分）</div>
          <div class="text-slate-600 text-xs mt-1">重点看好，超额收益预期 15-30%</div>
        </div>
        <div class="bg-slate-50 rounded-lg p-3 border border-slate-200">
          <div class="font-bold text-slate-700">B 级（5-7 分）</div>
          <div class="text-slate-600 text-xs mt-1">中性偏多，超额收益预期 0-15%</div>
        </div>
        <div class="bg-red-50 rounded-lg p-3 border border-red-200">
          <div class="font-bold text-red-700">C 级（&lt;5 分）</div>
          <div class="text-slate-600 text-xs mt-1">谨慎规避</div>
        </div>
      </div>
    </div>
